                                      ...
                                      const int      isvals16)
{
    ...
    Ptngc_comp_conv_to_huffman(vals, nvals, dict, ndict, hist, huffman + 14, &nhuff, huffdict,
                               &nhuffdict, huffdictunpack, &nhuffdictunpack);
    *huffdatalen = nhuff;
    ...
    Ptngc_comp_conv_to_huffman(huffdictunpack, nhuffdictunpack, dict, ndict1, hist, huffman1,
                               &nhuff1, huffdict1, &nhuffdict1, huffdictunpack1, &nhuffdictunpack1);
    ...
    Ptngc_comp_conv_to_rle(huffdictunpack, nhuffdictunpack, huffdictrle, &nhuffrle, 1);

    /* Determine probabilities. */
    Ptngc_comp_make_dict_hist(huffdictrle, nhuffrle, dict, &ndict2, hist);
    /* Pack huffman dictionary */
    Ptngc_comp_conv_to_huffman(huffdictrle, nhuffrle, dict, ndict2, hist, huffman2, &nhuff2,
                               huffdict2, &nhuffdict2, huffdictunpack2, &nhuffdictunpack2);
    huffman_lengths[2] = nhuff + nhuff2 + nhuffdict2 + 1 * 2 + 3 * 4 + 3 + 3 + 3 + 3 + 3 + 3;

    /* Choose the best algorithm and output the data. */
    if ((*chosen_algo == 0)
        || ((*chosen_algo == -1)
            && (((huffman_lengths[0] < huffman_lengths[1]) && (huffman_lengths[0] < huffman_lengths[2])))))
    {
        *chosen_algo        = 0;
    ...
    else if ((*chosen_algo == 1) || ((*chosen_algo == -1) && ((huffman_lengths[1] < huffman_lengths[2]))))
    {
        *chosen_algo        = 1;
...
void Ptngc_comp_huff_compress(unsigned int* vals, const int nvals, unsigned char* huffman, int* huffman_len)
{
...
void Ptngc_comp_huff_decompress(unsigned char* huffman, const int huffman_len, unsigned int* vals)
{
    int           isvals16 = (int)huffman[0];
    unsigned int* vals16   = NULL;
    int           algo     = (int)huffman[1];
    int           nvals16  = (int)((unsigned int)huffman[2] | (((unsigned int)huffman[3]) << 8)
                        | (((unsigned int)huffman[4]) << 16) | (((unsigned int)huffman[5]) << 24));
    int           nvals    = (int)((unsigned int)huffman[6] | (((unsigned int)huffman[7]) << 8)
                      | (((unsigned int)huffman[8]) << 16) | (((unsigned int)huffman[9]) << 24));
    int           nhuff    = (int)((unsigned int)huffman[10] | (((unsigned int)huffman[11]) << 8)
                      | (((unsigned int)huffman[12]) << 16) | (((unsigned int)huffman[13]) << 24));
    int ndict = (int)((unsigned int)huffman[17 + nhuff] | (((unsigned int)huffman[18 + nhuff]) << 8)
    ...
    {
        int nhuffdict =
                (int)((unsigned int)huffman[14 + nhuff] | (((unsigned int)huffman[15 + nhuff]) << 8)
                      | (((unsigned int)huffman[16 + nhuff]) << 16));
        Ptngc_comp_conv_from_huffman(huffman + 14, vals16, nvals16, ndict, huffman + 20 + nhuff,
                                     nhuffdict, NULL, 0);
    }
    else if (algo == 1)
    {
        ...
        int nhuffdictunpack =
                (int)((unsigned int)huffman[14 + nhuff] | (((unsigned int)huffman[15 + nhuff]) << 8)
                      | (((unsigned int)huffman[16 + nhuff]) << 16));
        int nhuff1 = (int)((unsigned int)huffman[20 + nhuff] | (((unsigned int)huffman[21 + nhuff]) << 8)
                           | (((unsigned int)huffman[22 + nhuff]) << 16));
        int nhuffdict1 =
                (int)((unsigned int)huffman[23 + nhuff] | (((unsigned int)huffman[24 + nhuff]) << 8)
                      | (((unsigned int)huffman[25 + nhuff]) << 16));
        int ndict1 = (int)((unsigned int)huffman[26 + nhuff] | (((unsigned int)huffman[27 + nhuff]) << 8)
                           | (((unsigned int)huffman[28 + nhuff]) << 16));
        Ptngc_comp_conv_from_huffman(huffman + 29 + nhuff, huffdictunpack, nhuffdictunpack, ndict1,
                                     huffman + 29 + nhuff + nhuff1, nhuffdict1, NULL, 0);
        /* Then decompress the "real" data. */
        Ptngc_comp_conv_from_huffman(huffman + 14, vals16, nvals16, ndict, NULL, 0, huffdictunpack,
                                     nhuffdictunpack);
        free(huffdictunpack);
    }
    else if (algo == 2)
    {
        ...
        int nhuffdictunpack =
                (int)((unsigned int)huffman[14 + nhuff] | (((unsigned int)huffman[15 + nhuff]) << 8)
                      | (((unsigned int)huffman[16 + nhuff]) << 16));
        int nhuffrle = (int)((unsigned int)huffman[20 + nhuff] | (((unsigned int)huffman[21 + nhuff]) << 8)
                             | (((unsigned int)huffman[22 + nhuff]) << 16));
        int nhuff2 = (int)((unsigned int)huffman[23 + nhuff] | (((unsigned int)huffman[24 + nhuff]) << 8)
                           | (((unsigned int)huffman[25 + nhuff]) << 16));
        int nhuffdict2 =
                (int)((unsigned int)huffman[26 + nhuff] | (((unsigned int)huffman[27 + nhuff]) << 8)
                      | (((unsigned int)huffman[28 + nhuff]) << 16));
        int ndict2 = (int)((unsigned int)huffman[29 + nhuff] | (((unsigned int)huffman[30 + nhuff]) << 8)
                           | (((unsigned int)huffman[31 + nhuff]) << 16));
        Ptngc_comp_conv_from_huffman(huffman + 32 + nhuff, huffdictrle, nhuffrle, ndict2,
...
static char* huff_algo_names[N_HUFFMAN_ALGO] = { "Huffman (dict=raw)", "Huffman (dict=Huffman)",
