...
static TNG_INLINE void Ptngc_widediv(unsigned int       hi,
                                     unsigned int       lo,
...
unsigned int Ptngc_largeint_div(const unsigned int v1,
